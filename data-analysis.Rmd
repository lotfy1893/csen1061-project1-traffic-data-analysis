...
When we looked at the unique values occur in each variable we noticed that we have 3 columns which has only two distinct values which are 0 or 1, which clearly indicates a boolean variables that will be investigated later on.
